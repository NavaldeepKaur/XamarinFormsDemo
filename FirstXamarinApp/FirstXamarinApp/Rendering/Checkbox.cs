...
namespace FirstXamarinApp.Rendering
{
    public class Checkbox : ContentView
    {
        ...
        public Checkbox()
        {
            ...
            this.Image.Source = "check_box_box.png";
        ...
        private static void CheckedValueChanged(BindableObject bindable, object oldValue, object newValue)
        {
            if (newValue != null && (Boolean)newValue == true)
                ((Checkbox)bindable).Image.Source = "check_box_selected.png";
            else
                ((Checkbox)bindable).Image.Source = "check_box_box.png";
        }
